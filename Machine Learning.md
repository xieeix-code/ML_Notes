...
![](assets/Machine%20Learning/RMSprop.png)
...
$$ \begin{align} m_t &= \beta_1 m_{t-1} + (1 - \beta_1)\nabla f(\theta_t) \\[4pt] v_t &= \beta_2 v_{t-1} + (1 - \beta_2)(\nabla f(\theta_t))^2 \\[4pt] \theta_{t+1} &= \theta_t - \eta \frac{m_t}{\sqrt{v_t} + \epsilon} \end{align} $$
